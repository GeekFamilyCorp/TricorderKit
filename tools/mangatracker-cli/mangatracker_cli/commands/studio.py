...
def add_parser(subparsers):
    parser = subparsers.add_parser("studio", help="Veille studios animation JP")
    action_sub = parser.add_subparsers(dest="action", required=True)
    p = action_sub.add_parser("scan", help="Scan studio")
    p.add_argument("--studio", required=True)
    p.add_argument("--format", choices=["markdown", "json"], default="markdown")
    p.add_argument("--output", default="exports")
    p = action_sub.add_parser("scan-works", help="Scan oeuvres studio")
    p.add_argument("--studio", required=True)
    p.add_argument("--format", choices=["markdown", "json"], default="markdown")
    p.add_argument("--output", default="exports")
