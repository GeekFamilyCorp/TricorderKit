...
def add_parser(subparsers):
    parser = subparsers.add_parser("seiyu", help="Veille seiyu JP")
    action_sub = parser.add_subparsers(dest="action", required=True)
    p = action_sub.add_parser("scan-agency", help="Scan agence seiyu")
    p.add_argument("--agency", required=True)
    p.add_argument("--format", choices=["markdown", "json"], default="markdown")
    p.add_argument("--output", default="exports")
    p = action_sub.add_parser("scan-cast", help="Scan cast anime")
