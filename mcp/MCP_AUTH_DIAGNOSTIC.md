...
C:\Users\sebas\AppData\Local\Packages\Claude_pzs8sxrjxfjjc\LocalCache\Roaming\Claude\claude_desktop_config.json

# ❌ Chemin apparent (redirigé, ne reflète pas toujours l'état réel)
C:\Users\sebas\AppData\Roaming\Claude\claude_desktop_config.json
```
...
| Vue | Chemin |
|-----|--------|
| Apparent (`%APPDATA%`) | `C:\Users\sebas\AppData\Roaming\Claude\` |
| Réel (MSIX sandbox) | `C:\Users\sebas\AppData\Local\Packages\Claude_pzs8sxrjxfjjc\LocalCache\Roaming\Claude\` |
