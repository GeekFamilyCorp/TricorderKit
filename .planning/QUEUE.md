...
| 1 | Mettre à jour instructions Space Cowork Japan-Alliance | Manuel (interface Cowork) | 10 min | ⬜ PENDING | Slot +0h |
| 4 | Générer BOOT_SUMMARY_JA.md dans claude-vault | Claude Code | 20 min | ⬜ PENDING | Slot +5h |
| 5 | Générer session_capsule_v0.9_JA.json à jour | Claude Code | 10 min | ⬜ PENDING | Slot +5h |
...
- [ ] Instructions Space mises à jour
- [ ] Template routing présent
- [ ] Extended Thinking désactivé par défaut
- [ ] Session rotation configurée
- [ ] Boot lazy-load configuré
...
### Critère de validation
- [ ] Fichier créé dans claude-vault
- [ ] Taille ≤ 500 tokens
- [ ] Phase active correcte
- [ ] Tâche prioritaire explicite
...
### Critère de validation
- [ ] Fichier généré dans vault/
- [ ] Copie dans claude-vault pour usage Cowork
- [ ] session_rules complètes
- [ ] open_tasks alignées avec BOOT_SUMMARY.md
...
- [ ] Action 1 validée (instructions Space mises à jour)
- [ ] Action 4 validée (BOOT_SUMMARY_JA.md créé)
- [ ] Action 5 validée (session_capsule_v0.9_JA.json créé)
...
*Créé : 2026-05-22 — Token Hygiene Plan v0.9*
